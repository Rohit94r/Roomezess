...
export default function LaundryOwnerDashboard() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || error.message || 'Failed to add laundry service';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900">Laundry Service Dashboard</h1>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="py-6">
          ...
          {activeTab === 'add-service' && (
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-medium text-gray-900">Add New Laundry Service</h2>
              </div>
              <div className="p-6">
                {message && (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                    <div>
                      ...
                      >
                        <option value="wash">Wash & Wear</option>
          ...
          {activeTab === 'manage-services' && (
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-medium text-gray-900">Manage Laundry Services</h2>
              </div>
              <div className="p-6">
                <p className="text-gray-500">Manage your laundry services here. (Functionality to be implemented)</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'orders' && (
            <div className="bg-white shadow rounded-lg overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200">
                <h2 className="text-lg font-medium text-gray-900">Recent Laundry Orders</h2>
              </div>
              <div className="p-6">
                <p className="text-gray-500">View and manage laundry orders here. (Functionality to be implemented)</p>
              </div>
            </div>
          )}
        </div>
