      ...
      <main className="py-8 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Discussions</h1>
            <p className="mt-2 text-gray-600">Talk about ideas, tips, and campus life.</p>
          </div>

          <div className="mb-6">
            <div className="flex flex-wrap gap-3">
              <a href="/community/discussions" className="px-3 py-2 rounded-lg text-sm font-semibold bg-primary-600 text-white">Discussions</a>
          ...
          {!checking && isVerified && (
            <div className="rounded-xl border border-gray-200 bg-white p-4 sm:p-5 shadow-sm mb-6">
              <div className="flex items-center justify-between">
                ...
                >
                  {showCreatePost ? 'Close' : 'New Discussion'}
                </button>
              </div>
              {showCreatePost && (
          ...
          {!checking && isVerified && (
            <>
              {loading ? (
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm text-center text-gray-600">No discussions yet.</div>
              ) : (
                <div className="space-y-4">
                  {posts.map((p) => (
                    <div key={p.id} className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                      <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium bg-blue-50 text-blue-700 border border-blue-200">Discussion</span>
